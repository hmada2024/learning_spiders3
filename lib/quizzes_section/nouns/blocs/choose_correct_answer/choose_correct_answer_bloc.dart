//lib/quizzes_section/nouns/blocs/choose_correct_answer/choose_correct_answer_bloc.dart
import 'dart:async';
import 'dart:math';
...
import 'package:learning_spiders/quizzes_section/shared_quizzes/helpers/quiz_options_generator.dart';
  ...
  Future<void> _onStartNewQuiz(
    ...
    Future<void> _onLoadNouns(LoadNouns event, Emitter<ChooseCorrectAnswerState> emit) async {
        ...
        try {
            ...
            List<Noun> nouns = await _nounRepository.getAllNouns();
